...
function SinglePage() {
	...
	const handelSaved = async () => {
		...
		setSaved(prev => !prev)
		try {
			await apiRequest.post('/user/saved', {
				postId: post.id
			})
		} catch (error) {
			console.log('🚀 ~ handelSaved ~ error:', error)
			setSaved(prev => !prev)
		}
	}
				...
				<div className="wrapper">
					...
					<div className="listVertical">
						<div className="feature">
							...
							<div className="featureText">
								<span>Utilities</span>
								{post.postDetail.utilities === 'owner' ? <p>Owner is responsible</p> : <p>Renter is responsible</p>}
							</div>
						</div>
						<div className="feature">
							<img src="/pet.png" alt="" />
					...
					<div className="buttons">
						...
						<button
							...
							{saved ? 'Remove the Place' : 'Add the Place'}
						</button>
					</div>
				</div>
			</div>
